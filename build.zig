...
pub fn build(b: *std.Build) !void {
    ...
    unit_tests.root_module.addImport("glfw", glfw_dep.module("mach-glfw"));
    @import("mach_glfw").addPaths(unit_tests);
    unit_tests.root_module.addImport("gl", b.createModule(.{
        .root_source_file = .{ .path = "libs/gl46.zig" },
    }));
    zmath_pkg.link(unit_tests);
    znoise_pkg.link(unit_tests);
